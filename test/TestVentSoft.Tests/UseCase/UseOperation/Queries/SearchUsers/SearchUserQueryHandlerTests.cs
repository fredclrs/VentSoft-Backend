...
namespace TestVentSoft.Tests.UseCase.UseOperation.Queries.SearchUsers
{
    public class SearchUserQueryHandlerTests
    {
        ...
        public async Task ReturnSuccess()
        {
            ...
            var documentoIdentidad = _fixture.Create<string>();
            var zona = _fixture.Create<string>();
            ...
            _usuarioQueryService
                .Setup(x => x.SearchUsersAsync(nombre, documentoIdentidad, zona))
            ...
            _usuarioQueryService.Verify(
                x => x.SearchUsersAsync(nombre, documentoIdentidad, zona),
                Times.Once
            );
        }
